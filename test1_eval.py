...
# 1. Base Scene XML content provided by the user
...
def prepare_test_scene_xml(input_content=SCENE_XML_CONTENT, output_path="/home/aidin/B/mujoco_project/panda_scripts/franka_emika_panda/scene_test.xml"):
    # Write base scene first
    with open("/home/aidin/B/mujoco_project/panda_scripts/franka_emika_panda/scene.xml", "w") as f:
...
class PandaSceneTesterApp:
    def __init__(self, model_path="panda_warp_ik_model"):
        # Load the PPO policy
        ...
        # Set to keyframe home position (resolved from include file)
    ...
    def on_close(self):
        ...
        if os.path.exists("/home/aidin/B/mujoco_project/panda_scripts/franka_emika_panda/scene_test.xml"):
            os.remove("/home/aidin/B/mujoco_project/panda_scripts/franka_emika_panda/scene_test.xml")
